...
/**
 * This function loads Level 2 with enemy objects, cloud objects, background objects, coin objects, and bottle objects.
...
/**
 * Creates an array of enemy objects for Level 2.
 * @returns {Array} An array of enemy objects.
 */
function createLevel2EnemieObjects() {
    return [
        new Endboss(),
        new Chicken(2),
        new Chicken(2),
...
/**
 * Creates an array of cloud objects for Level 2.
 * @returns {Array} An array of cloud objects.
 */
function createLevel2CloudObjects() {
    return [
...
/**
 * Creates an array of background objects for Level 2.
 * @returns {Array} An array of background objects.
 */
function createLevel2BackgroundObjects() {
    return [
...
/**
 * Creates an array of coin objects for Level 2.
 * @returns {Array} An array of coin objects.
 */
function createLevel2CoinObjects() {
    return [
        new Coin(1),
        new Coin(2),
        new Coin(3),
...
/**
 * Creates an array of bottle objects for Level 2.
 * @returns {Array} An array of bottle objects.
 */
function createLevel2BottleObjects() {
    return [
